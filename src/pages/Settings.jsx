    ...
    <div className="p-8 text-white">
      ...
      <div className="bg-gray-800 p-8 rounded-lg shadow-xl mb-8 max-w-md">
        ...
        <div className="space-y-3">
          <a href={process.env.REACT_APP_DISCORD_BOT_INVITE || '#'} target="_blank" rel="noopener noreferrer" className="block bg-blue-600 hover:bg-blue-700 text-white font-bold py-3 px-4 rounded text-center transition">
            🤖 Invite Bot to Discord
          </a>
          <a href="https://github.com/charanreddy9866/Fitness-Coach" target="_blank" rel="noopener noreferrer" className="block bg-gray-700 hover:bg-gray-600 text-white font-bold py-3 px-4 rounded text-center transition">
            💻 View on GitHub
          </a>
        </div>
      </div>
